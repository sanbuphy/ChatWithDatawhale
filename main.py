...
from dwchatbot.utils.file_operation import FileOperation
from dwchatbot.rag import CacheRetriever, Retriever
...
def test_query(retriever: Retriever, samples: str = None):
...
if __name__ == '__main__':
    ...
    samples = ['学习python推荐的课程']
    test_query(retriever, samples)
