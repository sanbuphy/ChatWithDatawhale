...
deepapi_key = os.getenv("deepseekapi")
moonapi_key = os.getenv("moonapi")
openapi_key = os.getenv("chatgptapi")
...
if __name__ == '__main__':
    ...
    # 配置 export_dir
    export_dir = "./temp"  # 请替换为实际readme的目录路径
    summary_dir="./tempsummary"# 请替换为实际readme的概括的目录路径
